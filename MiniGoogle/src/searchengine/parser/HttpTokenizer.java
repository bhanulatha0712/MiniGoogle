...
public class HttpTokenizer {
    ...
    /** A constant indicating an "alt" has been read. */
    public static final int HT_ALT = 14;
    /** A constant indicating a "frame" has been read. */
    public static final int HT_FRM = 15;
    /** A constant indicating an "iframe" has been read. */
    public static final int HT_IFRM = 16;
	...
	if (word != null && word.hasMoreTokens()) {
	    ...
	    if (sval.equals("img")) return HT_IMG;
            ...
            if (sval.equals("frame")) return HT_FRM;
            if (sval.equals("iframe")) return HT_IFRM;
